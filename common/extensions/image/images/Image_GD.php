...
class Image_GD extends Image {
	...
	public static function check()
	{
		...
		{
			throw new CException('Image_GD requires GD version :required or greater, you have :version',
	...
	public function __construct($file)
	{
		...
		{
			throw new CException('Installed GD does not support :type images',
	...
	protected function _do_rotate($degrees)
	{
		...
		{
			throw new CException('This method requires :function, which is only available in the bundled version of GD',
