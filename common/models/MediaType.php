 ...
 * @property Post[] $posts
 */
class MediaType extends Details
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'posts' => array(self::HAS_MANY, 'Post', 'media_type'),
		);
	}
	...
	{
		$_media_type = self::model()->findAll(array('order'=>'id'));
		return CHtml::listData($_media_type, 'id', 'name');
	}
